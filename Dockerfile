...
LABEL org.opencontainers.image.url="https://github.com/ASFHyP3/hyp3-insar-gamma"
LABEL org.opencontainers.image.source="https://github.com/ASFHyP3/hyp3-insar-gamma"
...
RUN python3 -m pip install --no-cache-dir hyp3_insar_gamma${SDIST_SPEC} \
